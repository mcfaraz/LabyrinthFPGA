...
#
# Generated by export_simulation on Sun Dec 03 00:31:27 +0000 2017
#
################################################################################
...
./dist_mem_gen_minecraftCobStone.sh
...
switch to the './dist_mem_gen_minecraftCobStone.sh' script.

./dist_mem_gen_minecraftCobStone.sh -reset_run
...
./dist_mem_gen_minecraftCobStone.sh -noclean_files

For more information on the script, please type './dist_mem_gen_minecraftCobStone.sh -help'.
