...
#
# Generated by export_simulation on Sun Dec 03 00:20:54 +0000 2017
#
################################################################################
...
switch to the './dist_mem_gen_xilinx.sh' script.

./dist_mem_gen_xilinx.sh -reset_run
...
./dist_mem_gen_xilinx.sh -noclean_files

For more information on the script, please type './dist_mem_gen_xilinx.sh -help'.
