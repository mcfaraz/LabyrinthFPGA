...
#
# Generated by export_simulation on Sun Dec 03 00:51:41 +0000 2017
#
################################################################################
...
switch to the './dist_mem_gen_earth.sh' script.

./dist_mem_gen_earth.sh -reset_run
...
./dist_mem_gen_earth.sh -noclean_files

For more information on the script, please type './dist_mem_gen_earth.sh -help'.
