...
#
# Generated by export_simulation on Sat Dec 02 23:38:03 +0000 2017
#
################################################################################
...
switch to the './dist_mem_gen_astro.sh' script.

./dist_mem_gen_astro.sh -reset_run
...
./dist_mem_gen_astro.sh -noclean_files

For more information on the script, please type './dist_mem_gen_astro.sh -help'.
