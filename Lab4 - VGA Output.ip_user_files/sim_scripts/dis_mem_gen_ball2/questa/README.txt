...
#
# Generated by export_simulation on Thu Dec 07 20:58:30 +0000 2017
#
################################################################################
...
switch to the './dis_mem_gen_ball2.sh' script.

./dis_mem_gen_ball2.sh -reset_run
...
./dis_mem_gen_ball2.sh -noclean_files

For more information on the script, please type './dis_mem_gen_ball2.sh -help'.
