...
#
# Generated by export_simulation on Sun Dec 03 01:25:30 +0000 2017
#
################################################################################
...
switch to the './dist_mem_gen_windows.sh' script.

./dist_mem_gen_windows.sh -reset_run
...
./dist_mem_gen_windows.sh -noclean_files

For more information on the script, please type './dist_mem_gen_windows.sh -help'.
