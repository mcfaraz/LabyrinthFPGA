...
#
# Generated by export_simulation on Thu Dec 07 19:42:31 +0000 2017
#
################################################################################
...
switch to the './dist_mem_gen_galaxy.sh' script.

./dist_mem_gen_galaxy.sh -reset_run
...
./dist_mem_gen_galaxy.sh -noclean_files

For more information on the script, please type './dist_mem_gen_galaxy.sh -help'.
