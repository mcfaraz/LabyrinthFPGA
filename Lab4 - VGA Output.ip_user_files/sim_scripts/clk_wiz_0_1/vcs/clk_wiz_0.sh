...
#
# Generated by Vivado on Thu Nov 23 14:29:35 +0000 2017
...
# Script info
echo -e "clk_wiz_0.sh - Script generated by export_simulation (Vivado v2017.2.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    $ref_dir/../../../../Lab4\\ -\\ VGA\\ Output.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0_clk_wiz.v \
    $ref_dir/../../../../Lab4\\ -\\ VGA\\ Output.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0.v \
  2>&1 | tee -a vlogan.log
