...
HD_PWD='H:/ES3B2/LabyrinthFPGA/Lab4 - VGA Output.runs/dist_mem_gen_earth_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_mem_gen_earth.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_mem_gen_earth.tcl
