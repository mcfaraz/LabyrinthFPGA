...
HD_PWD='H:/ES3B2/LabyrinthFPGA/Lab4 - VGA Output.runs/dist_mem_gen_xilinx_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_mem_gen_xilinx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_mem_gen_xilinx.tcl
