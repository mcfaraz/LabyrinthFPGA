...
HD_PWD='H:/ES3B2/LabyrinthFPGA/Lab4 - VGA Output.runs/dis_mem_gen_ball2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dis_mem_gen_ball2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dis_mem_gen_ball2.tcl
