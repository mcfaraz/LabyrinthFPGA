...
drawcon draw_mod (.frameclk(frameclk),.ctrBtn(ctrBtn), .leftBtn(leftBtn), .rightBtn(rightBtn), .upBtn(upBtn), .downBtn(downBtn), .draw_r(tmpR), .draw_g(tmpG), .draw_b(tmpB), .draw_x(curr_x), .draw_y(curr_y));
